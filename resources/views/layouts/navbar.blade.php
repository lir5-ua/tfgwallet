<nav
    class="bg-white text-black dark:bg-slate-800 dark:text-white p-4 rounded  relative flex flex-wrap items-center justify-between px-0 py-2 mx-6 transition-all shadow-none duration-250 ease-soft-in rounded-2xl lg:flex-nowrap lg:justify-start"
    ...
    <div class="flex items-center justify-between w-full px-4 py-1 mx-auto flex-wrap-inherit">
        ...
        $titulo = $nombres[$rutaActual] ?? 'Página';
        @endphp

        <nav>
            <ol class="bg-white text-black dark:bg-slate-800 dark:text-white flex flex-wrap pt-1 mr-12 bg-transparent rounded-lg sm:mr-16">
                <li class="leading-normal text-sm">
                    <a class="bg-white text-black dark:bg-slate-800 dark:text-white opacity-50 text-slate-700" href="{{ route('usuarios.index') }}">Inicio</a>
                </li>
                <li class="bg-white text-black dark:bg-slate-800 dark:text-white text-sm pl-2 capitalize leading-normal text-slate-700 before:float-left before:pr-2 before:text-gray-600 before:content-['/']"
                    aria-current="page">
                    {{ $titulo }}
                </li>
            </ol>
            <h6 class="bg-white text-black dark:bg-slate-800 dark:text-white mb-0 font-bold capitalize">{{ $titulo }}</h6>
        </nav>
