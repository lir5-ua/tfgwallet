   ...
   {{ request()->is('mascotas') ? 'bg-white font-semibold text-slate-700 rounded-lg shadow-soft-xl' : 'text-slate-500' }}">
    ...
    <div class="mx-4">
        ...
        <div
            ...
            sidenav-card>
            <div class="mb-7.5 absolute h-full w-full rounded-2xl bg-cover bg-center bg-[url('{{ asset('assets/img/curved-images/white-curved.jpeg') }}')]">
            </div>
            ...
            <div class="relative z-20 flex-auto w-full p-4 text-left text-white">
                <div
                    ...
                    <i class="top-0 z-10 text-lg leading-none text-transparent ni ni-diamond bg-gradient-to-tl from-slate-600 to-slate-300 bg-clip-text opacity-80"
                       aria-hidden="true" sidenav-card-icon></i>
                </div>
